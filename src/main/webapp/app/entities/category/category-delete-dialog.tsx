...
export const CategoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="demoSpringReactApp.category.delete.question">
        <Translate contentKey="demoSpringReactApp.category.delete.question" interpolate={{ id: categoryEntity.id }}>
