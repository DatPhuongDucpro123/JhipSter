  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="demoSpringReactApp.jobs.home.createOrEditLabel" data-cy="JobsCreateUpdateHeading">
            <Translate contentKey="demoSpringReactApp.jobs.home.createOrEditLabel">Create or edit a Jobs</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('demoSpringReactApp.jobs.title')}
                id="jobs-title"
                name="title"
                data-cy="title"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('demoSpringReactApp.jobs.slug')}
                id="jobs-slug"
                name="slug"
                data-cy="slug"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('demoSpringReactApp.jobs.featureImage')}
              ...
              />
              <ValidatedField
                label={translate('demoSpringReactApp.jobs.validFrom')}
                id="jobs-validFrom"
                name="validFrom"
                data-cy="validFrom"
                type="datetime-local"
              ...
              />
              <ValidatedField
                label={translate('demoSpringReactApp.jobs.validThrough')}
              ...
              />
              <ValidatedField
                label={translate('demoSpringReactApp.jobs.status')}
                id="jobs-status"
                name="status"
                data-cy="status"
                type="select"
              >
                {jobStatusValues.map(jobStatus => (
                  <option value={jobStatus} key={jobStatus}>
                    {translate('demoSpringReactApp.JobStatus.' + jobStatus)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('demoSpringReactApp.jobs.createdBy')}
                id="jobs-createdBy"
                name="createdBy"
                data-cy="createdBy"
                type="text"
              />
              <ValidatedField
                label={translate('demoSpringReactApp.jobs.createdDate')}
                id="jobs-createdDate"
                name="createdDate"
                data-cy="createdDate"
                type="datetime-local"
              ...
              />
              <ValidatedField
                label={translate('demoSpringReactApp.jobs.updateDate')}
                id="jobs-updateDate"
                name="updateDate"
                data-cy="updateDate"
                type="datetime-local"
              ...
              />
              <ValidatedField
                label={translate('demoSpringReactApp.jobs.updateBy')}
                id="jobs-updateBy"
                name="updateBy"
                data-cy="updateBy"
                type="text"
              ...
              <ValidatedField
                ...
                name="category"
                data-cy="category"
                label={translate('demoSpringReactApp.jobs.category')}
                type="select"
              >
                <option value="" key="0" />
                {categories
